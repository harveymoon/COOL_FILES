...
const GITHUB_RELEASES_API_URL: &str =
    "https://api.github.com/repos/harveymoon/COOL_FILES/releases?per_page=100";
...
mod tests {
        ...
        let upgrade = pick_best_installable_upgrade(
            vec![GithubRelease {
                ...
                assets: vec![serde_json::json!({
                    "name": "Cool-Files-2.1.1-windows.msixbundle",
    ...
    fn pick_best_installable_upgrade_picks_highest_with_setup_exe() {
        let upgrade = pick_best_installable_upgrade(
            vec![
                GithubRelease {
                    ...
                    assets: vec![serde_json::json!({
                        "name": "Cool-Files-2.0.0-beta.1-windows-setup.exe",
                ...
                GithubRelease {
                    ...
                    assets: vec![serde_json::json!({
                        "name": "Cool-Files-2.0.0-beta.2-windows-setup.exe",
        ...
        assert_eq!(upgrade.2, "Cool-Files-2.0.0-beta.2-windows-setup.exe");
    }
    ...
    fn executable_path_indicates_windows_store_install_matches_windows_apps() {
        assert!(executable_path_indicates_windows_store_install(
            r"C:\Program Files\WindowsApps\6609AlekseyHoffman.CoolFiles_2.1.0.0_x64__abc123\cool_files.exe"
        ));
        assert!(!executable_path_indicates_windows_store_install(
            r"C:\Program Files\Cool Files\cool_files.exe"
        ));
    }
