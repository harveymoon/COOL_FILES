...
- **Trình quản lý tệp mặc định**: đặt Cool Files làm trình quản lý tệp mặc định trên Windows (`Cài đặt > Thử nghiệm`);
...
Cool Files v2 đã được xây dựng lại từ đầu sử dụng Vue 3 Composition API, TypeScript và Tauri v2. Kích thước cài đặt ứng dụng giảm từ 153 MB xuống chỉ 4 MB trên Windows. Kích thước ứng dụng đã cài đặt giảm từ 419 MB xuống 12 MB.
